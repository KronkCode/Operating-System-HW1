...
def main():
    if len(sys.argv) < 3:
        print("Usage: python your_script.py input_file_path output_file_path [quantum]")
        sys.exit(1)
    ...
    quantum, process_count, run_for, algorithm, processes = read_input_file(input_file_path)
